...
-----------------------------
The examples below are part of the JavaScript scripting simulation. 
They demonstrate the use of JavaScript scripts to extend the functionality of API Simulator.

Take a look at the simlet.yaml files to understand how to configure scripting that uses JavaScript.

Running the Examples
--------------------
Start the API Simulator locally - follow the online directions. 
For example:
  apisimulator start examples/scripting-js

Run the given cURL and/or API Client command for each of the simlets:

* create-payment
This example demonstrates the use of a placeholder which content is produced by JavaScript script. 
The script is located in the "scripts" subdirectory under the simulation’s directory.
  ...
  * using API Client:
 apiclient -v -h localhost -p 6090 -f "examples/scripting-js/tests/create-payment-1.http"
 apiclient -v -h localhost -p 6090 -f "examples/scripting-js/tests/create-payment-2.http"
